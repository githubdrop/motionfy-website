...
const services = [
  {
    ...
    subtitle: "Position Your Science for Success",
    description: "We develop compelling brand strategies that differentiate your science in competitive markets and resonate with your target audiences.",
    features: [
  ...
  },
  {
    ...
    subtitle: "Reach & Engage Your Audiences",
    description: "Data-driven digital campaigns that connect with HCPs, patients, investors, and other key stakeholders across all channels.",
    features: [
  ...
  {
    id: "scientific-communications",
    icon: Microscope,
    title: "Scientific Communications",
    subtitle: "Translate Complex Science",
    description: "Expert medical writing and scientific content that makes complex data accessible and compelling to diverse audiences.",
    features: [
  ...
  },
  {
    ...
    description: "Compliant marketing strategies that maximize impact while navigating complex FDA, EMA, and global regulatory requirements.",
    features: [
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 hero-pattern">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          >
            ...
            >
              From strategy to execution, we provide comprehensive marketing solutions designed 
              specifically for the unique challenges of the life sciences industry.
            </motion.p>
          </motion.div>
        </div>
      </section>
              ...
              >
                ...
                <div className={`relative ${i % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <div className="rounded-3xl overflow-hidden shadow-xl">
                    <img 
                      src={
                        i === 0 ? "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=800" :
                        i === 1 ? "https://images.unsplash.com/photo-1677442136019-21780ecad995?w=800" :
                        i === 2 ? "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800" :
                        "https://images.unsplash.com/photo-1576669801838-1b1c52121e6a?w=800"
                      }
                      alt={service.title}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              We offer a full range of specialized services to support your marketing needs.
            </p>
          </div>
